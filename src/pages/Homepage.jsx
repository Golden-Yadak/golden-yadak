      ...
      <main>
        ...
        <section className="border-y border-white/10 bg-zinc-900/60">
          <div className="mx-auto w-full max-w-7xl px-4 py-10">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 text-center text-xl font-extrabold text-white/70 sm:grid-cols-3 md:grid-cols-6">
              {["PORSCHE", "BMW", "AUDI", "MERCEDES", "MASERATI", "FERRARI"].map(
                (brand) => (
                  <a key={brand} href="#" className="transition hover:text-white">
                    {brand}
                  </a>
                )
              )}
            ...
            {[
              {
                ...
                title: "فیلتر روغن اورجینال سری M",
                old: "۴,۵۰۰,۰۰۰",
                price: "۳,۸۰۰,۰۰۰",
              },
              {
                ...
                title: "شمع ایریدیوم لیزری - سفارش آلمان",
                old: "۱,۲۰۰,۰۰۰",
                price: "۱,۰۵۰,۰۰۰",
              },
              {
                ...
                title: "دیسک ترمز کربن-سرامیک پرفورمنس",
                old: "۱۲,۰۰۰,۰۰۰",
                price: "۱۰,۸۰۰,۰۰۰",
              },
            ].map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2">
                    <span className="text-white/45 line-through">{item.old}</span>
              ...
              {[
                {
                  ...
                  title: "باتری لیتیومی فوق سبک موتوراسپرت",
                  price: "۸,۹۰۰,۰۰۰",
                },
                {
                  ...
                  badge: "۵ لیتر",
                  badgeStyle: "border border-white/10 bg-white/5 text-white/80",
                  title: "روغن موتور استر پایه سینتتیک - تاییدیه ریسینگ",
                  price: "۴,۲۰۰,۰۰۰",
                },
              ].map((item) => (
                <article
                  key={item.title}
                  className="flex flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-zinc-950 sm:flex-row"
                >
                  <img
                    src={item.img}
                    alt={item.title}
                  ...
                  <div className="flex flex-col justify-between p-6">
                    <div>
                      <span
                        className={`inline-block rounded-full px-3 py-1 text-xs font-bold ${item.badgeStyle}`}
                      >
                        {item.badge}
                      </span>
            ...
            {[
              {
                ...
                title: "کیت کلاچ تقویت شده پلاتینیوم",
                price: "۱۵,۵۰۰,۰۰۰",
              },
              {
                img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCjS2rlmnoHyvMpiADRRCL7LpLtZIrmJKRu3KMzXfPUMiohQJ70haHAjTA1-Q1yg4OgSvOdQsPicw8jFDx7K1UQDLS2rujbgvqK_LwDn1_3bV3RsxAUA2Bq4UqBsun0564ZLouGKo23WI05xQY1948Y5bqBkb0su-t1iAXlRIR7JMzAq-xRY1wbqlpUgHGkc6zojMsVjfNu8n0PLMuJRtT4tK3aHnP6pnky6fVqwV_1RSgmuk0qwMwOyOPqbYPhJtFVEhkFOcIBNIk",
                title: "لاستیک تخصصی زمستانه سری Z",
                price: "۹,۸۰۰,۰۰۰",
              },
            ].map((item) => (
              <article
                key={item.title}
                className="flex flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-zinc-900 md:flex-row"
              >
                <img
                  src={item.img}
                  alt={item.title}
                ...
                <div className="flex flex-col justify-between p-6">
                  <h3 className="text-xl font-bold leading-8">{item.title}</h3>
        ...
        <section className="mx-auto w-full max-w-7xl px-4 pb-20">
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {[
              ["verified", "اصالت تضمین شده", "ارائه شناسنامه معتبر برای تمامی قطعات خاص"],
              ["flight_takeoff", "ارسال اختصاصی", "حمل ایمن و سریع با سرویس اختصاصی وی‌آی‌پی"],
              ["handyman", "کارشناس فنی همراه", "مشاوره تخصصی نصب و راه‌اندازی قطعات پیچیده"],
              ["history_edu", "گارانتی طلایی", "طرح جایگزینی سریع قطعات بدون پرسش"],
            ].map(([icon, title, desc]) => (
              <div
                key={title}
                className="rounded-[1.75rem] border border-white/10 bg-zinc-900 p-6"
              >
                <span className="material-symbols-outlined text-3xl text-amber-400">
                  {icon}
                </span>
